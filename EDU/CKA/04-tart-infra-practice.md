...
export KUBECONFIG=kubeconfig/platform.kubeconfig:kubeconfig/dev.kubeconfig:kubeconfig/staging.kubeconfig:kubeconfig/prod.kubeconfig
...
```bash
# 여러 kubeconfig 파일 병합
KUBECONFIG=kubeconfig/platform.kubeconfig:kubeconfig/dev.kubeconfig \
