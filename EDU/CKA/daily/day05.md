...
# 권한 테스트
kubectl auth can-i delete pods --as=tom -n demo         # yes
kubectl auth can-i create services --as=tom -n demo      # yes
kubectl auth can-i create configmaps --as=tom -n demo    # no (configmaps 권한 없음)
```
