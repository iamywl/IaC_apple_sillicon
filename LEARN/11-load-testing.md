...
- [이번 글에서 배울 것](#이번-글에서-배울-것)
- [부하 테스트란?](#부하-테스트란)
  - [실제 프로젝트에서는](#실제-프로젝트에서는)
- [k6 — HTTP 부하 생성기](#k6--http-부하-생성기)
  - [k6란?](#k6란)
  - [k6 스크립트 기본 구조](#k6-스크립트-기본-구조)
- [VU(Virtual User)란?](#vuvirtual-user란)
- [stress-ng — CPU/메모리 스트레스 테스트](#stress-ng--cpu메모리-스트레스-테스트)
  - [stress-ng란?](#stress-ng란)
  - [stress-ng Job 생성 코드](#stress-ng-job-생성-코드)
- [Kubernetes Job — 테스트를 실행하는 방법](#kubernetes-job--테스트를-실행하는-방법)
  - [Job의 핵심 설정](#job의-핵심-설정)
- [16가지 테스트 시나리오 상세 설명](#16가지-테스트-시나리오-상세-설명)
  - [카테고리 1: HTTP 부하 테스트 (6가지)](#카테고리-1-http-부하-테스트-6가지)
  - [카테고리 2: 스케일링 테스트 (3가지)](#카테고리-2-스케일링-테스트-3가지)
  - [카테고리 3: 캐스케이드 테스트 (3가지)](#카테고리-3-캐스케이드-테스트-3가지)
  - [카테고리 4: CPU 스트레스 테스트 (2가지)](#카테고리-4-cpu-스트레스-테스트-2가지)
  - [카테고리 5: 메모리 스트레스 테스트 (2가지)](#카테고리-5-메모리-스트레스-테스트-2가지)
- [테스트 결과 이해하기](#테스트-결과-이해하기)
  - [HTTP 테스트 핵심 지표](#http-테스트-핵심-지표)
  - [왜 p95/p99를 보는가?](#왜-p95p99를-보는가)
  - [CPU/메모리 스트레스 테스트 결과](#cpu메모리-스트레스-테스트-결과)
- [스케일링 테스트의 특별한 점](#스케일링-테스트의-특별한-점)
  - [쿨다운(Cooldown) 기간](#쿨다운cooldown-기간)
- [캐스케이드 테스트의 작동 원리](#캐스케이드-테스트의-작동-원리)
  - [일반 테스트 vs 캐스케이드 테스트](#일반-테스트-vs-캐스케이드-테스트)
  - [관찰할 수 있는 것](#관찰할-수-있는-것)
- [네트워크 정책과 테스트](#네트워크-정책과-테스트)
- [CSV 내보내기 — 결과 분석](#csv-내보내기--결과-분석)
  - [CSV 내보내기 구조](#csv-내보내기-구조)
- [테스트 실행 전체 흐름 요약](#테스트-실행-전체-흐름-요약)
- [한 줄 요약](#한-줄-요약)
