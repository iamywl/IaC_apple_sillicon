...
**검증 - 기대 출력 (레이블 확인):**
```text
NAME          STATUS   ROLES           AGE   VERSION   ENVIRONMENT     DISK
dev-master    Ready    control-plane   10d   v1.31.0
dev-worker1   Ready    <none>          10d   v1.31.0   development
```
...
platform-master   4     8052736Ki    110
platform-worker1  4     8052736Ki    110
```

PODS 열은 해당 노드에서 실행 가능한 최대 Pod 수를 나타낸다. 기본값은 110이다. 메모리 단위 Ki는 키비바이트(kibibyte)이며, 8052736Ki는 약 7.7GiB이다.
...
admin.conf                 Jan 01, 2025 00:00 UTC   <invalid>
apiserver                  Jan 01, 2025 00:00 UTC   <invalid>
```
