...
web-frontend-svc   NodePort   10.96.x.x      <none>        80:30180/TCP   5s

# kubectl get endpoints web-frontend-svc
NAME               ENDPOINTS                                               AGE
web-frontend-svc   10.244.x.x:80,10.244.x.x:80,10.244.x.x:80 + 1 more...  5s
```
...
log-collector   2         2         2       2            2           <none>           10s

# kubectl get pods -n kube-system -l app=log-collector -o wide
NAME                  READY   STATUS    RESTARTS   AGE   NODE
log-collector-xxxxx   1/1     Running   0          10s   worker1
log-collector-yyyyy   1/1     Running   0          10s   worker2
```
