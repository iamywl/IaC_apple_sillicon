...
```text
E0330 10:15:00.123456  admission.go:187] Failed calling webhook: dial tcp 10.96.0.5:443: connect: connection refused
```
...
```text
Warning  Failed   kubelet  Failed to pull image "nginx@sha256:wrong...": manifest unknown
```
