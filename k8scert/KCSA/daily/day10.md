...
**해결:** KCSA(Kubernetes and Cloud Native Security Associate)는 개념 기반 시험으로, 4C 모델, STRIDE, MITRE ATT&CK, CIS Benchmark, NIST CSF 등 보안 프레임워크와 도구의 이해도를 측정한다. 객관식 50문제, 75분, 67% 합격이다.
